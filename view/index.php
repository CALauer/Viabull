            ...
            <div class="landing-wrapper">
                <div>
                    <div class="landing-title">
                        <h1>I bet you're a hard worker. So let ur hard earned money work for you. Start investing today.</h1>
                        <p>Thanks for checking out my page. I jsut started this project on 12/16/2020. You can stay up-to-date with upcoming updates <a href="../view/updates.php" class="myaccount-links">here.</a> </p>
                    </div>
                    <div>
                        <ul>
